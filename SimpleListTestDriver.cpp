//File name - SimpleListTestDriver.cpp
//Name - Karthik Narayan
//Course Number - CPS 400
// This file contains the test cases that will be executed on the linked list implementation. Proper cout statements are written describing the purpose of each of the test case
#include <cstdlib>
#include <ctime>
...
void NodeSLList_Test()
{
	...
	cout << "*****************************************************************************" << endl;
	cout << "Adding n5 to tail of list2\n";
	list2.AddToTail(n5);
	cout << "cout << list2 " << endl;
	cout << list2;
	...
	cout << "cout << list2 " << endl;
	cout << list2 << endl;
	cout << "InsertNode(3,n1) should insert n1 after position 3 of list2\n";
	list2.InsertNode(3, n1);
	cout << "cout << list2 " << endl;
	cout << list2 << endl;
	...
	cout << "*****************************************************************************" << endl;
	cout << "We will sort list1 to test the sort functionality\n";
	list1.SortList(1);
	cout << "cout << list1 " << endl;
	cout << list1 << endl;
